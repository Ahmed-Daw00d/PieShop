using DawoodShopNew.TagHelpers;
...
namespace DawoodShopNewTest.TagHelpers
{
    public class EmailTagHelperTests
    {
        ...
        {
            EmailTagHelper emailTagHelper = new EmailTagHelper() { Adress = "test@bethanyspieshop.com", Contact = "Email" }; ;
