...
namespace DawoodShopNewTest.Mocks
{
    ...
    public static Mock<ICategoriesRepository> GetCategoryRepository()
        {
            var Categories = new List<Category>
            {
                ...
                {
                    CategoryId = 0,
                    NameCategory = "Fruit Pies",
                    Description = "Lorem ipsum"
                },
                new Category()
                {
                    CategoryId = 1,
                    NameCategory = "Cheese cakes",
                    Description = "Lorem ipsum"
                },
                new Category()
                {
                    CategoryId = 2,
                    NameCategory = "Seasonal pies",
            ...
            if(_categories == null)
                {
                    ...
                    {
                        new Category { NameCategory = "Cheese cakes" },
                        new Category { NameCategory = "Fruit pies" },
                        new Category { NameCategory = "Seasonal pies" }
                    ...
                    foreach(var genres in genresList)
                    {
                        ...
                        _categories.Add(genres.NameCategory, genres);
                    }
